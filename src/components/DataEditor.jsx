...
import { Plus, Trash2, Save, Undo, Redo, Check, GripVertical, ChevronUp, ChevronDown } from 'lucide-react';
...
export function DataEditor({ initialData, onSave }) {
    ...
    // Simple move row up/down functions (more reliable than drag)
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="overflow-x-auto rounded-xl border border-white/5">
                <table className="w-full text-sm text-left">
                    <thead className="text-[10px] text-gray-500 uppercase bg-slate-800/50">
                        <tr>
                            <th className="px-1 py-2.5 w-12"></th>
                                ...
                                <td className="px-1 py-1.5">
                                    <div className="flex flex-col items-center gap-0.5">
                                        <button
                                            ...
                                            disabled={rowIndex === 0}
                                            className="p-0.5 text-gray-600 hover:text-yellow-500 disabled:opacity-20 disabled:hover:text-gray-600 transition-colors"
                                            title="Move up"
                                        >
            ...
            <p className="text-[10px] text-gray-600">
                Use ▲▼ arrows to reorder rows • Double-click cells in preview for inline editing
            </p>
        </div>
    );
}
